										...
										<tr>
											<td valign="top" class="bodyContent" sytle="border-collapse:collapse;">
												<div sytle="color:#000000;font-family:'Lucida Sans Unicode',sans-serif,Verdana,Arial;font-size:13pt;line-height:140%;text-align:left;">
													...
													<p>Veuillez cliquer sur le lien ci-dessous pour vérifier votre adresse email&nbsp;:<br />
														<a href="$SubscriptionVerificationLink" id="subscription-link">$HashText</a>
													</p>
													<p>Ce lien sera valide pendant $DaysExpired jours. Si vous ne souhaitez pas vous inscrire, veuillez ignorer cet email.</p>
													
													<% if MailingLists %>
														<h5>Une fois que votre email sera vérifié vous serez inscrit à notre newsletter.</h5>

														<% if MemberInfoSection %><h5>Vos informations&nbsp;:</h5>
															<ul>
