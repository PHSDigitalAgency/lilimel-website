...
class GalleryUploadField_ItemHandler extends UploadField_ItemHandler {
	...
	public function EditForm() {
		...
		if(isset($joinObj->ID)){
			...
			if($joinObj->hasField('Caption')){
				$data['Caption'] = $joinObj->Caption;
			}

			if($joinObj->hasField('LinkToUrlID')){
				$data['LinkToUrlID'] = $joinObj->LinkToUrlID;
			}

			if($joinObj->hasField('UseAsThumb')){
				$data['UseAsThumb'] = $joinObj->UseAsThumb;
			}

			if($joinObj->hasField('Layout')){
				$data['Layout'] = $joinObj->Layout;
			}
